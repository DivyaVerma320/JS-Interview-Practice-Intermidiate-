...
a. Hoisting:
Within the function b, due to JavaScript's hoisting mechanism, the local function declaration function a() {} is hoisted to the top of the 
function b scope. This means the function declaration will shadow any other variable named a within the function b. So the function b will 
look like this after hoisting:
javascript function b() { function a() {} a = 10; console.log("b", a); //10 }

b. Local Scope Assignment:
Now, a = 10; inside the function b refers to the local a (which is a function due to hoisting). JavaScript allows functions to be assigned 
new values, so a is set to 10.
